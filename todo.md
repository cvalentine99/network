...
- [x] Slice 18 — Blast Radius Surface: standalone "Who is affected?" panel, case assembly, device impact visualization, GET /api/bff/blast-radius BFF route, shared types/validators, fixtures (populated/quiet/error/transport-error/malformed), tests, screenshots (idle/loading/populated/quiet/error), truth receipt
